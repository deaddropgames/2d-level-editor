...
public class LevelSaveDialog extends JDialog implements ActionListener, MouseListener {
	...
	public LevelSaveDialog() {
		...
		{
			JLabel lblTitle = new JLabel(ResourceBundle.getBundle("ca.squadcar.games.editor.gui.messages").getString("LevelSaveDialog.lblTitle.text")); //$NON-NLS-1$ //$NON-NLS-2$
		...
		{
			JLabel lblAuthor = new JLabel(ResourceBundle.getBundle("ca.squadcar.games.editor.gui.messages").getString("LevelSaveDialog.lblAuthor.text")); //$NON-NLS-1$ //$NON-NLS-2$
		...
		{
			JLabel lblRevision = new JLabel(ResourceBundle.getBundle("ca.squadcar.games.editor.gui.messages").getString("LevelSaveDialog.lblRevision.text")); //$NON-NLS-1$ //$NON-NLS-2$
		...
		{
			JLabel lblDifficulty = new JLabel(ResourceBundle.getBundle("ca.squadcar.games.editor.gui.messages").getString("LevelSaveDialog.lblDifficulty.text")); //$NON-NLS-1$ //$NON-NLS-2$
		...
		}
		{
			...
			comboDifficulty.setModel(new DefaultComboBoxModel(new String[] {
					ResourceBundle.getBundle("ca.squadcar.games.editor.gui.messages").getString("LevelSaveDialog.comboDifficulty.circle"),
					ResourceBundle.getBundle("ca.squadcar.games.editor.gui.messages").getString("LevelSaveDialog.comboDifficulty.square"),
					ResourceBundle.getBundle("ca.squadcar.games.editor.gui.messages").getString("LevelSaveDialog.comboDifficulty.diamond"),
					ResourceBundle.getBundle("ca.squadcar.games.editor.gui.messages").getString("LevelSaveDialog.comboDifficulty.doubleDiamond")
					}));
		...
		{
			JLabel lblDescription = new JLabel(ResourceBundle.getBundle("ca.squadcar.games.editor.gui.messages").getString("LevelSaveDialog.lblDescription.text"));
		...
		{
			JLabel lblFilename = new JLabel(ResourceBundle.getBundle("ca.squadcar.games.editor.gui.messages").getString("LevelSaveDialog.lblFilename.text"));
		...
		}
		{
			...
			{
				cancelButton = new JButton(ResourceBundle.getBundle("ca.squadcar.games.editor.gui.messages").getString("LevelSaveDialog.cancelButton.text")); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public void updateForMeta(final boolean isExport, final String defaultDir, final String currFilename, final JsonLevel level) {
		...
		if(isExport) {
			...
			setTitle(ResourceBundle.getBundle("ca.squadcar.games.editor.gui.messages").getString("LevelSaveDialog.exportDlg.title"));
			okButton.setText(ResourceBundle.getBundle("ca.squadcar.games.editor.gui.messages").getString("LevelSaveDialog.okButton.exportText"));
		} else {
			
			setTitle(ResourceBundle.getBundle("ca.squadcar.games.editor.gui.messages").getString("LevelSaveDialog.saveDlg.title"));
			okButton.setText(ResourceBundle.getBundle("ca.squadcar.games.editor.gui.messages").getString("LevelSaveDialog.okButton.saveText"));
		}
	...
	public void actionPerformed(ActionEvent event) {
		...
		if(event.getSource() == okButton) {
			...
			if(txtTitletextfield.getText().isEmpty()) {
				...
				errMsg += ResourceBundle.getBundle("ca.squadcar.games.editor.gui.messages").getString("LevelSaveDialog.validationError.title") + "\n";
			}
			
			if(txtDescriptiontextarea.getText().isEmpty()) {
				
				errMsg += ResourceBundle.getBundle("ca.squadcar.games.editor.gui.messages").getString("LevelSaveDialog.validationError.desc") + "\n";
			}
			
			if(txtFilenametextfield.getText().isEmpty()) {
				
				errMsg += ResourceBundle.getBundle("ca.squadcar.games.editor.gui.messages").getString("LevelSaveDialog.validationError.filename") + "\n";
			}
			...
			if(!errMsg.isEmpty()) {
				...
				JOptionPane.showMessageDialog(this,
						errMsg,
						ResourceBundle.getBundle("ca.squadcar.games.editor.gui.messages").getString("LevelSaveDialog.validationError.dlgTitle"),
	...
	public void mouseClicked(MouseEvent event) {
		...
		if(event.getSource() == txtFilenametextfield) {
			...
			FileNameExtensionFilter filter = new FileNameExtensionFilter(
					ResourceBundle.getBundle("ca.squadcar.games.editor.gui.messages").getString("LevelSaveDialog.fileType.text"), 
					"json");
			fc.setFileFilter(filter);
			
			fc.setDialogTitle(ResourceBundle.getBundle("ca.squadcar.games.editor.gui.messages").getString("LevelSaveDialog.fileChooser.title"));
			int returnVal = fc.showDialog(this, ResourceBundle.getBundle("ca.squadcar.games.editor.gui.messages").getString("LevelSaveDialog.fileChooser.approveText"));
			if(returnVal == JFileChooser.APPROVE_OPTION) {
				...
				for(String reservedName : reservedFilenames) {
					...
					if(reservedName.compareToIgnoreCase(file.getName()) == 0) {
						...
						JOptionPane.showMessageDialog(fc, 
								ResourceBundle.getBundle("ca.squadcar.games.editor.gui.messages").getString("LevelSaveDialog.fileChooser.reservedFileMsg.text"),
								ResourceBundle.getBundle("ca.squadcar.games.editor.gui.messages").getString("LevelSaveDialog.fileChooser.reservedFileMsg.title"),
								JOptionPane.ERROR_MESSAGE);
						return;
					}
				}
				...
				if(file.exists()) {
					...
					if(JOptionPane.showConfirmDialog(fc, ResourceBundle.getBundle("ca.squadcar.games.editor.gui.messages").getString("LevelSaveDialog.fileChooser.existsMsg.text")) != JOptionPane.YES_OPTION) {
